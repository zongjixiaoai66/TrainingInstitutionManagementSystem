               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="上课时间" prop="kechengDa">
                       <el-input v-model="ruleForm.kechengDa"
                                 placeholder="上课时间" clearable  :readonly="ro.kechengDa"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengFile" label="课表信息" prop="kechengFile">
                        <file-upload
                                tip="点击上传课表信息"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengFile" label="课表信息" prop="kechengFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.kechengFile"  >课表信息下载</a>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   kechengFile: [
                              { required: true, message: '课表信息不能为空', trigger: 'blur' },
                          ],
                   kechengClicknum: [
