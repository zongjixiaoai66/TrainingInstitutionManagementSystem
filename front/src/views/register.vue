    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">艺体培训机构业务管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <el-form-item label="学员名称" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuName" autocomplete="off" placeholder="学员名称"  />
                        </el-form-item>
                        ...
                        <!--
                            ...
                            <el-form-item label="学员头像" class="input" v-if="tableName=='yonghu'">
                                    <file-upload
                                        tip="点击上传学员头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                        <el-form-item label="学员邮箱" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuEmail" autocomplete="off" placeholder="学员邮箱"  />
                        </el-form-item>
                        <!--
